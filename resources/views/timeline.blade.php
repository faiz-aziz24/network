                    ...
                    <form action="{{ route('statuses.store') }}" method="post">
                        ...
                        <div class="flex">
                            ...
                            <div class="w-full">
                                ...
                                <div class="my-2">
                                    <textarea name="body" id="body" placeholder="what is your mind?" class="form-textarea w-full border-gray-300 rounded-xl resize-none focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200"></textarea>
